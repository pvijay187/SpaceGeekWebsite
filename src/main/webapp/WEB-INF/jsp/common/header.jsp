...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <c:url value="/alienWeightCalc" var="alienWeightCalcPage"/>
            <li><a href="${alienWeightCalcPage}">Alien Weight</a></li>
            <c:url value="/driveTimeCalc" var="driveTimeCalcPage" />
            <li><a href="${driveTimeCalcPage}">Drive Time</a></li>  
            <c:url value="/spaceForum" var="spaceForumPage" />
            <li><a href="${spaceForumPage}">Space Forum</a></li>  
            <c:url value="/spaceProductList" var="spaceProductList" />
            <li><a href="${spaceProductList}">Space Store</a></li>               
        </ul>
    </nav>